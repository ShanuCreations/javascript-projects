...
function buildBoard() {
    ...
    playArea.scorer.innerText = "Popper Game";
    playArea.stats.appendChild(playArea.scorer);
    let rows = 4;
    let cols = 4;
    let cnt = 0;
    playArea.game.style.width = cols * 100 + (cols * 2);//scale the width of the gameArea to make it dynamic
    playArea.game.style.margin = "auto"; //to center an element
